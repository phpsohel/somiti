...
@section('content')
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('updateweeklydepositPayment', $details->id) }}" class="" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="number" step="any" name="weekly_fee" value="{{ $details->weekly_fee }}"
