                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('weeklydeposit.store') }}" method="POST">
                                @csrf
                                <div class="row">
                                    @php
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            @endphp
                                            <input type="date" name="weekly" value="{{  $friday }}" required
                                                class="form-control">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="deposite_date" value="{{ date('Y-m-d') }}" required
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <a href="{{ route('weeklydeposit.index') }}" class="btn btn-success btn-sm"><i
