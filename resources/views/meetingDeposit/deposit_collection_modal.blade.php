<div class="modal fade" id="loanDeposite_{{ $depositdetail->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('meetingDepositPayment') }}" class="" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="row">

                        <input type="hidden" name="deposit_details_id" value="{{ $depositdetail->id }}">
                        <input type="hidden" name="deposit_id" value="{{ $depositdetail->meeting_deposit_id }}">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="number" step="any" name="meeting_fee"
                                value="{{ old('meeting_fee', $depositdetail->meeting_fee) }}"
