...
@if (session()->has('message'))
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('updatemeetingdepositPayment',$details->id) }}" class="" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="number" step="any" name="meeting_fee" value="{{ $details->meeting_fee }}"
                                class="form-control meeting_fee" required readonly>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="number" name="meeting_fine" class="form-control" value="{{ $details->meeting_fine }}">
                        </div>
                        {{-- @if ($details->payment_type == 2) --}}
