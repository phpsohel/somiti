                    ...
                    <tbody style="">
                        ...
                        <tr style="font-size: 20px; text-align:center">
                            @if ($detail->payment_type == 1)
                                <th colspan="5">Meeting Money Receipt</th>
                            @elseif ($detail->payment_type == 2)
                                <th colspan="8">Meeting Money Receipt</th>
                            @else
                                <th colspan="5">Meeting Money Receipt</th>
                            @endif
                        </tr>
                        ...
                        <tr>
                            <td valign="top">
                                <table cellpadding="3" cellspacing="0" border="1"
                                    style="width:100%; border-collapse: collapse; font-size:18px;martin-top:10px;">
                                    <thead>
                                    ...
                                    <tbody>
                                        <tr style="text-align: center">
                                            ...
                                            @endif
                                            <td>{{ $detail->meeting_fee ?? '' }}</td>
                                            <td>{{ $detail->meeting_fine ?? '' }}</td>
