                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('meetingdeposite.store') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <a href="{{ route('meetingdeposite.index') }}" class="btn btn-success btn-sm "><i
