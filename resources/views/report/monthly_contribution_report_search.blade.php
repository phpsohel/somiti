                        ...
                        <table class="table table-bordered table-sm table-striped text-nowrap">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th class="text-right">{{ trans('Monthly fee') }}</th>
                                    <th class="text-right">{{ trans('Monthly fine') }}</th>
                            ...
                            <tbody>
                                @php
                                    ...
                                    $grand_total = 0;
                                @endphp
                                @foreach ($monthlyDetails as $key => $detail)
                                    @php
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">{{ $detail->monthly_fee ?? 0 }}</td>
                                        <td class="text-right">{{ $detail->monthly_fine ?? 0 }}</td>
