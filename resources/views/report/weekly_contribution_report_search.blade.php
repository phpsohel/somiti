        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header mt-2">
                    {{-- <h3 class="text-center">{{ trans('weekly Deposit Report') }}</h3> --}}
                </div>
                        ...
                        <table class="table table-bordered table-sm table-striped text-nowrap">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th class="text-right">{{ trans('Weekly fee') }}</th>
                                    <th class="text-right">{{ trans('Weekly fine') }}</th>
                            ...
                            <tbody>
                                @php
                                    ...
                                    $grand_total = 0;
                                @endphp
                                @foreach ($weeklyDetails as $key => $detail)
                                    @php
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">{{ $detail->weekly_fee ?? 0 }}</td>
                                        <td class="text-right">{{ $detail->weekly_fine ?? 0 }}</td>
