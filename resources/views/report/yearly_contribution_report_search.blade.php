        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header mt-2">
                    {{-- <h3 class="text-center">{{ trans('yearly Deposit Report') }}</h3> --}}
                </div>
                {!! Form::open(['route' => 'report.yearlyContributionReportSearch', 'method' => 'post']) !!}
                <div class="row ml-2">
                        ...
                        <table class="table table-bordered table-sm table-striped text-nowrap">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th class="text-right">{{ trans('Yearly fee') }}</th>
                                    <th class="text-right">{{ trans('Yearly fine') }}</th>
                            ...
                            <tbody>
                                @php
                                    ...
                                    $grand_total = 0;
                                @endphp
                                @foreach ($yearlyDetails as $key => $detail)
                                    @php
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">{{ $detail->yearly_fee ?? 0 }}</td>
                                        <td class="text-right">{{ $detail->yearly_fine ?? 0 }}</td>
