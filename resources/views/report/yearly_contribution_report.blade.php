@extends('layout.main') @section('content')
    ...
    <section class="forms">
        ...
        <div class="container" id="table_print">
            <div class="card">
                <div class="card-header mt-2">
                    <h3 class="text-center ">{{ trans('Yearly Contribution Summary') }}</h3>
                        ...
                        <table class="text-center table table-bordered table-sm table-striped text-nowrap">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th>{{ trans('Mobile') }}</th>
                                    <th>{{ trans('Amount') }}</th>
                                    <th>{{ trans('Deposit Yearly') }}</th>
                                    <th>{{ trans('Yearly Count') }}</th>
                                    <th class="due_amount">{{ trans('Due/Advance Yearly') }}</th>
