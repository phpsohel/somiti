@extends('layout.main') @section('content')
    ...
    <section class="forms">
        ...
        <div class="container" id="table_print">
            <div class="card">
                <div class="card-header mt-2">
                    <h3 class="text-center ">{{ trans('Daily Contribution Summary') }}</h3>
                </div>
                <div class="card-body">
                    {{-- site title --}}
                    <div class="container">
                        ...
                        <table class="text-center table table-bordered table-sm table-striped text-nowrap">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th>{{ trans('Mobile') }}</th>
                                    <th>{{ trans('Amount') }}</th>
                                    <th>{{ trans('Deposit Day') }}</th>
                                    <th>{{ trans('Day Count') }}</th>
                                    <th class="due_amount">{{ trans('Due/Advance Day') }}</th>
                            ...
                            <tbody id="allResult">
                                @forelse ($customers as $customer)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $customer->id }}</td>
                                        <td>{{ $customer->name }} ({{ $customer->member_code }})</td>
                            ...
                            <tr>
                                ...
                                <th colspan="1" class="text-danger">{{ $totalGivenDayCount }} </th>
                                <th colspan="1">{{ $totalDepositDay }}</th>
                                <th colspan="1" class="text-danger">-{{ $totalDueDay }}</th>
                                <th>{{ number_format($totalDueAmount) }}</th>
                            </tr>
                        </table>
                    </div>
                </div>
