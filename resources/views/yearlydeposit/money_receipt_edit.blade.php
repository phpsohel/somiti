...
@section('content')
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('updateyearlydepositPayment', $details->id) }}" class="" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="number" step="any" name="yearly_fee" value="{{ $details->yearly_fee }}"
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="number" name="yearly_fine" class="form-control"
                                value="{{ $details->yearly_fine }}">
                        </div>
