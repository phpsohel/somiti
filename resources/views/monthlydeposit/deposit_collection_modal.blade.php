<div class="modal fade" id="loanDeposite_{{ $depositdetail->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('depositPayment') }}" class="" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="row">

                        <input type="hidden" name="deposit_details_id" value="{{ $depositdetail->id }}">
                        <input type="hidden" name="deposit_id" value="{{ $depositdetail->monthly_deposits_id }}">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="number" step="any" name="monthly_fee"
                                value="{{ old('monthly_fee', $depositdetail->monthly_fee) }}"
                    ...
                    <input type="number"  name="grand_total" class="form-control grand_total" value="{{ old('grand_total',$depositdetail->monthly_fee) }}" required readonly>
