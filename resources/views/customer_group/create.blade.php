...
<section>
    <div class="container-fluid">
        <a href="#" data-toggle="modal" data-target="#createModal" class="btn btn-info btn-sm"><i class="dripicons-plus"></i> {{trans('file.Add Customer Group')}}</a>
        <a href="#" data-toggle="modal" data-target="#importcustomer_group" class="btn btn-primary btn-sm"><i class="dripicons-copy"></i> {{trans('file.Import Customer Group')}}</a>
    </div>
