<div class="modal fade" id="loanDeposite_<?php echo e($depositdetail->id); ?>" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('yearlydepositPayment')); ?>" class="" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="row">

                        <input type="hidden" name="deposit_details_id" value="<?php echo e($depositdetail->id); ?>">
                        <input type="hidden" name="yearly_deposit_id" value="<?php echo e($depositdetail->yearly_deposit_id); ?>">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="number" step="any" name="yearly_fee"
                                value="<?php echo e($depositdetail->yearly_fee); ?>" class="form-control " id="yearly_fee_fixed"
                                required readonly>
...
<script></script>
<?php /**PATH C:\xampp\htdocs\somiti\resources\views/yearlydeposit/deposit_collection_modal.blade.php ENDPATH**/ ?>