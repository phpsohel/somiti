                    ...
                    <div class="col-md-2 mt-4">
                        <div class="form-group d-flex mt-2">
                            ...
                            <button class="btn btn-success btn-sm ml-2 text-white"
                                onclick="exportTableToCSV('yearlyContributionReport.csv')">
                                Export To CSV
                            </button>
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered table-sm table-striped text-nowrap">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th class="text-right"><?php echo e(trans('Yearly fee')); ?></th>
                                    <th class="text-right"><?php echo e(trans('Yearly fine')); ?></th>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $grand_total = 0;
                                ?>
                                <?php $__currentLoopData = $yearlyDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        $total_fee += $detail->yearly_fee;
                                        $total_fine += $detail->yearly_fine;
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><?php echo e($detail->yearly_fee ?? 0); ?></td>
                                        <td class="text-right"><?php echo e($detail->yearly_fine ?? 0); ?></td>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\somiti\resources\views/report/yearly_contribution_report_search.blade.php ENDPATH**/ ?>