        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a class="btn btn-dark btn-sm" href="<?php echo e(route('deposite.index')); ?>"><i class="fa fa-undo px-2"></i>
                        Back</a> &nbsp;
                        ...
                        <thead>
                            <tr class="">
                                <th class="text-center text-success" colspan="13">
                                    <div class="">Deposit List : <?php echo e($item->month . ' , ' . $item->years); ?></div>
                            ...
                            <?php $__currentLoopData = $depositdetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $depositdetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <a href="<?php echo e(route('moneyreceiptSingle', $depositdetail->id)); ?>"
                                                target="_blank" class="btn btn-info btn-sm w-100"><i
                                                    class="fa fa-money px-2"></i> Money Receipt</a>
                                            
                                            <?php if(!empty(auth()->user()->role_id == 1)): ?>
                                                <a href="<?php echo e(route('monthly_money_receipt_edit', $depositdetail->id)); ?>"
                                    ...
                                    <td class="text-right"><?php echo e($depositdetail->monthly_fee ?? ''); ?></td>
                                    <td class="text-right"><?php echo e($depositdetail->monthly_fine ?? 0); ?></td>
                                    <td class="text-right">
                                        <?php echo e(number_format(($depositdetail->monthly_fee ?? 0) + ($depositdetail->monthly_fine ?? 0), 2)); ?>

                                    </td>


                                </tr>
                                <?php echo $__env->make('monthlydeposit.deposit_collection_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="modal fade" id="addDepositDetailModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('deposit.singleCustomerStore')); ?>" class="" method="POST">
                    <?php echo csrf_field(); ?>
                                    ...
                                    <select required class="form-control getmember_value" id="customer-group-id"
                                        ...
                                        <?php $__currentLoopData = $generalMemberLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($data->id); ?>"
                                                data-fee="<?php echo e($data->monthly_deposit_fee); ?>" class="generalMembers">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\somiti\resources\views/monthlydeposit/deposit_details.blade.php ENDPATH**/ ?>