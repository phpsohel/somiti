    ...
    <section>
        <div class="card">
                        ...
                        <div class="col-lg-3">
                            <div class="btn-group">
                                <?php if(in_array('customers-add', $all_permission)): ?>
                                    <a href="<?php echo e(route('memberinfo.create')); ?>" class="btn btn-info btn-sm"><i
                                            class="dripicons-plus"></i> <?php echo e(trans('Add Member')); ?></a>&nbsp;
            ...
            <div class="card-body">
                    ...
                    <table id="" class="table table-bordered table-sm table-striped text-nowrap">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo e(trans('Member Status')); ?></th>
                                <th><?php echo e(trans('Member Type')); ?></th>
                                <th><?php echo e(trans('Member Code')); ?></th>
                                <th><?php echo e(trans('file.name')); ?></th>
                                <th><?php echo e(trans('file.Company Name')); ?></th>
                                <th><?php echo e(trans('file.Email')); ?></th>
                                <th><?php echo e(trans('file.Phone Number')); ?></th>
                                <th><?php echo e(trans('Emergency Phone No')); ?></th>
                                <th><?php echo e(trans('Permanent Address')); ?></th>
                                <th><?php echo e(trans('Present Address')); ?></th>
                                <th><?php echo e(trans('Joining Fee')); ?></th>
                        ...
                        <tbody id="customerSearchResult">
                            <?php $__currentLoopData = $lims_customer_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr data-id="<?php echo e($customer->id); ?>">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default"
                                                ...
                                                <?php if(in_array('customers-edit', $all_permission)): ?>
                                                    <li>
                                                        <a href="<?php echo e(route('memberinfo.edit', $customer->id)); ?>"
                                                            class="btn btn-link"><i class="dripicons-document-edit"></i>
                                                            <?php echo e(trans('file.edit')); ?></a>
                                                    </li>
                                                <?php endif; ?>
                                                <li>
                                                    <a href="<?php echo e(route('customer.profile', $customer->id)); ?>"
                                                        class="btn btn-link"><i class="fa fa-user"></i> Profile</a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo e(route('memberDepositDetail', $customer->id)); ?>"
                                    ...
                                    <td><?php echo e($customer->member_code ?? ''); ?></td>
                                    <td><?php echo e($customer->name ?? ''); ?></td>
                                    <td><?php echo e($customer->company_name ?? ''); ?></td>
                                    <td><?php echo e($customer->email ?? ''); ?></td>
                                    <td><?php echo e($customer->phone_number ?? ''); ?></td>
                                    <td><?php echo e($customer->emergency_number ?? ''); ?></td>
                                    <td><?php echo e($customer->permanent_address ?? ''); ?></td>
                                    <td><?php echo e($customer->address ?? ''); ?>,
                                        <?php echo e($customer->city ?? ''); ?><?php echo e($customer->country ?? ''); ?></td>
                                    <td><?php echo e($customer->joining_fee ?? ''); ?></td>
                ...
                <?php echo e($lims_customer_all->links()); ?>
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p><?php echo e(trans('file.The correct column order is')); ?> (customer_group*, name*, company_name, email,
    ...
    <script type="text/javascript">
        ...
        $('.searchCustomer').on('keyup', function() {
            ...
            $.ajax({
                type: 'get',
                dataType: 'HTML',
                url: '<?php echo e(route('customersearching')); ?>',
                data: {
                    search: search
                },
                'global': false,
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\somiti\resources\views/customer/index.blade.php ENDPATH**/ ?>