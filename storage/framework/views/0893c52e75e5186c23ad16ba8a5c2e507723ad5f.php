 <?php $__env->startSection('content'); ?>
    ...
    <section>
        <div class="card">
            ...
            <div class="card-header">
                <h4 class="card-title mb-2"> Meeting Deposit Details </h4>

                <div class="card-tools">
                    <a class="btn btn-dark btn-sm" href="<?php echo e(route('meetingdeposite.index')); ?>"><i class="fa fa-undo px-2"></i>
                        Back</a> &nbsp;
                    ...
                    <table id="customer-table" class="table table-bordered table-sm table-striped">
                        <thead>
                            <tr class="">
                                <th class="text-center text-success" colspan="13">
                                    <div class="">Meeting Deposit List : <?php echo e($item->month . ' , ' . $item->year); ?>
                            ...
                            <tr>
                                ...
                                <th>Cheque Number</th>
                                <th>Payment Date</th>
                                <th class="text-right">Meeting Fee</th>
                                <th class="text-right">Meeting Fine</th>
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $depositdetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $depositdetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $total_meeting_fee += $depositdetail->meeting_fee;
                                    $total_meeting_fine += $depositdetail->meeting_fine;
                                    $grandtotal += ($depositdetail->meeting_fee ?? 0) + ($depositdetail->meeting_fine ?? 0);
                                ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <a href="<?php echo e(route('meetingmoneyreceiptSingle', $depositdetail->id)); ?>"
                                            ...
                                            <?php if(!empty(auth()->user()->role_id == 1)): ?>
                                                <a href="<?php echo e(route('meeting_money_receipt_edit', $depositdetail->id)); ?>"
                                    ...
                                    <td class="text-right"><?php echo e($depositdetail->meeting_fee ?? ''); ?></td>
                                    <td class="text-right"><?php echo e($depositdetail->meeting_fine ?? 0); ?></td>
                                    <td class="text-right">
                                        <?php echo e(number_format(($depositdetail->meeting_fee ?? 0) + ($depositdetail->meeting_fine ?? 0), 2)); ?>

                                    </td>


                                </tr>
                                <?php echo $__env->make('meetingDeposit.deposit_collection_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                        <tfoot>
                            <tr class="">
                                <th class="text-right" colspan="10">Total</th>
                                <th class="text-right"><?php echo e(number_format($total_meeting_fee ?? 0, 2)); ?></th>
                                <th class="text-right"><?php echo e(number_format($total_meeting_fine ?? 0, 2)); ?></th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-center" id="">Add Meeting Deposit Details</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <form action="<?php echo e(route('singlecustomermeetingdepositstore')); ?>" class="" method="POST">
                    <?php echo csrf_field(); ?>

                    <div class="modal-body">
                        <div class="row">

                            <input type="hidden" id="deposit_month" name="deposit_month" value="<?php echo e($item->month); ?>">
                            <input type="hidden" id="deposit_year" name="deposit_year" value="<?php echo e($item->year); ?>">
                            <input type="hidden" id="deposite_date" name="deposite_date"
                                value="<?php echo e($item->deposite_date ?? ''); ?>">

                            <div class="col-md-6">
                                <div class="form-group">
                                    <label><?php echo e(trans('Meeting Members')); ?> <sup class="text-danger">*</sup></strong>
                                    </label>
                                    <select required class="form-control getmember_value" id="customer-group-id"
                                        ...
                                        <?php $__currentLoopData = $generalMemberLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($data->id); ?>" data-fee="<?php echo e($data->meeting_fee); ?>"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="meetingDepositFee" name="meeting_fee"
                                        value="" readonly>
                                </div>
                            </div>
    ...
    <script>
        ...
        $(document).on('keyup', '.meeting_fine', function() {
            var meeting_fine = $(this).val();
            var meeting_fee = $('.meeting_fee').val();
            if (!meeting_fine) meeting_fine = 0;
            var total = (parseFloat(meeting_fee) + parseFloat(meeting_fine));
        ...
        $(document).ready(function() {
            ...
            $('.getmember_value').on('change', function() {
                ...
                $("#meetingDepositFee").val(depositFee);
                // alert(depositFee);
            });
        });
    </script>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\somiti\resources\views/meetingDeposit/deposit_details.blade.php ENDPATH**/ ?>