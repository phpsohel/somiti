 <?php $__env->startSection('content'); ?>
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo e(route('weeklydeposit.store')); ?>" method="POST">
                                ...
                                <div class="row">
                                            ...
                                            <select name="years" class="form-control">
                                                <?php $__currentLoopData = $years; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($year ?? ''); ?>"
                                                        <?php echo e($year == date('Y') ? 'Selected' : ''); ?>><?php echo e($year ?? ''); ?></option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Weekly (Start from friday) <sup class="text-danger">*</sup></strong> </label>
                                            <?php
                                                $friday = date('Y-m-d', strtotime('friday this week'));
                                            ?>
                                            <input type="date" name="weekly" value="<?php echo e($friday); ?>" required
                                                class="form-control">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <a href="<?php echo e(route('weeklydeposit.index')); ?>" class="btn btn-success btn-sm"><i
    ...
    <script type="text/javascript">
        ...
        $("ul#general #general-add-weekly-deposit-menu").addClass("active");
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\somiti\resources\views/weeklydeposit/create.blade.php ENDPATH**/ ?>