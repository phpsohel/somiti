                        ...
                        <tbody id="allDepositResult">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><?php echo e(++$i); ?></td>
                                    <td>
                                        <a href="<?php echo e(route('dailydepositdetails', $item->id)); ?>"
                                            class="btn btn-primary btn-sm"><i class="fa fa-th"></i>
                                            Deposit Details
                                        </a>
                                        <a href="<?php echo e(route('dailyMoneyReceipt', $item->id)); ?>" target="_blank"
                                    ...
                                    <td>
                                        <b class="text-success">
                                            <?php if(!empty($item->dailyDepositPaid)): ?>
                                                <?php echo e($item->dailyDepositPaid->depositPaid ?? 0); ?>

                                            <?php else: ?>
                                                0
                                            <?php endif; ?>
                                            / <span class="text-primary">
                                                <?php if(!empty($item->dailyDepositAll)): ?>
                                                    <?php echo e($item->dailyDepositAll->allDeposite ?? 0); ?>
    ...
    <script>
        ...
        $("#searchDeposit").on('keyup', function() {
            ...
            if (search) {
                ...
                $.ajax({
                    type: 'get',
                    url: '<?php echo e(route('search_daily_deposit_by_ajax')); ?>',
                    data: {
                        search: search
                    },
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\somiti\resources\views/dailydeposit/index.blade.php ENDPATH**/ ?>