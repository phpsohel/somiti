 <?php $__env->startSection('content'); ?>
    ...
    <section class="forms">
        ...
        <div class="container" id="table_print">
            <div class="card">
                <div class="card-header mt-2">
                    <h3 class="text-center "><?php echo e(trans('Weekly Contribution Summary')); ?></h3>
                        ...
                        <table class="text-center table table-bordered table-sm table-striped text-nowrap">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th class=""><?php echo e(trans('Deposit Weekly')); ?></th>
                                    <th><?php echo e(trans('Weekly Count')); ?></th>
                                    <th class="due_amount"><?php echo e(trans('Due/Advance Weekly')); ?></th>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class=""><?php echo e($deposit); ?></td>
                                        <?php if($due == 0): ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\somiti\resources\views/report/weekly_contribution_report.blade.php ENDPATH**/ ?>