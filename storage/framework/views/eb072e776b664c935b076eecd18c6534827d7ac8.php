                    ...
                    <div class="col-md-2 mt-4">
                        <div class="form-group d-flex mt-2">
                            ...
                            <button class="btn btn-success btn-sm ml-2 text-white"
                                onclick="exportTableToCSV('MonthlyContributionReport.csv')">
                                Export To CSV
                            </button>
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered table-sm table-striped text-nowrap">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th class="text-right"><?php echo e(trans('Monthly fee')); ?></th>
                                    <th class="text-right"><?php echo e(trans('Monthly fine')); ?></th>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $grand_total = 0;
                                ?>
                                <?php $__currentLoopData = $monthlyDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        $total_fee += $detail->monthly_fee;
                                        $total_fine += $detail->monthly_fine;
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><?php echo e($detail->monthly_fee ?? 0); ?></td>
                                        <td class="text-right"><?php echo e($detail->monthly_fine ?? 0); ?></td>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\somiti\resources\views/report/monthly_contribution_report_search.blade.php ENDPATH**/ ?>