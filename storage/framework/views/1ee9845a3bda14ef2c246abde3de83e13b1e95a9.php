                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php echo Form::open(['route' => 'setting.generalStore', 'files' => true, 'method' => 'post']); ?>
                            ...
                            <div class="form-group">
                                <input type="submit" value="<?php echo e(trans('Save')); ?>" class="btn btn-primary btn-sm">
                            </div>
                        <?php echo Form::close(); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\somiti\resources\views/setting/general_setting.blade.php ENDPATH**/ ?>