            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-lg-6 col-md-6 offset-md-3">
                        <h2 class="text-center"><i class="fa fa-university mb-2"></i> Weekly General Member Deposit List
                        </h2>
                        <br>
                ...
                <button class="btn btn-success btn-sm pull-right"
                    onclick="exportTableToCSV('WeeklyDepositList.csv')"  style="font-size: 1rem;">
                    Export To CSV
                </button>
            </div>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo e(route('weeklydepositdetails', $item->id)); ?>"
                                            class="btn btn-primary btn-sm"><i class="fa fa-th"></i> Deposit
                                            Details</a>
                                        <a href="<?php echo e(route('weeklyMoneyReceipt', $item->id)); ?>" data-id=""
                                    ...
                                    <td>
                                        <b class="text-success">
                                            <?php if(!empty($item->weeklyDepositPaid)): ?>
                                                <?php echo e($item->weeklyDepositPaid->paid ?? 0); ?>

                                            <?php else: ?>
                                                0
                                            <?php endif; ?>
                                            / <span class="text-primary">
                                                <?php if(!empty($item->weeklyDepositAll)): ?>
                                                    <?php echo e($item->weeklyDepositAll->alldeposit ?? 0); ?>
    ...
    <script>
        ...
        $("#searchDeposit").on('keyup', function() {
            ...
            if (search) {
                ...
                $.ajax({
                    type: 'get',
                    url: '<?php echo e(route('search_weekly_deposit_by_ajax')); ?>',
                    data: {
                        search: search
                    },
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\somiti\resources\views/weeklydeposit/index.blade.php ENDPATH**/ ?>