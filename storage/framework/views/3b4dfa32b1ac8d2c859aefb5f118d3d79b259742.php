                    ...
                    <tbody style="">
                        ...
                        <tr style="font-size: 20px;text-align:center;">
                            <?php if($detail->payment_type == 1): ?>
                                <th colspan="5">Monthly Money Receipt</th>
                            <?php elseif($detail->payment_type == 2): ?>
                                <th colspan="8">Monthly Money Receipt</th>
                            <?php else: ?>
                                <th colspan="5">Monthly Money Receipt</th>
                            <?php endif; ?>
                        </tr>
                        ...
                        <tr>
                            <td colspan="8" style="width: 75%;">
                                <h6 style="margin:0%"><b>Member Name :</b> <?php echo e($detail->member->name ?? ''); ?>
                                    ...
                                    (<?php echo e($detail->member->member_code ?? ''); ?> )</h6>
                        ...
                        <tr>
                            <td valign="top">
                                <table cellpadding="3" cellspacing="0" border="1"
                                    style="width:100%; border-collapse: collapse; font-size:18px; margin-top:10px;">
                                    <thead>
                                        ...
                                        <tr style="text-align: center">
                                            <td colspan="">
                                                <div class="">
                                                    ...
                                                    <?php echo e($detail->month ?? 0); ?> , <?php echo e($detail->years ?? 0); ?></div>
                                            </td>
                                            <td>
                                                <?php if($detail->payment_type == 1): ?>
                                                    <p>Cash</p>
                                            ...
                                            <td><?php echo e($detail->transition_id ?? '-'); ?></td>
                                            <?php if($detail->payment_type == 2): ?>
                                                <td><?php echo e($detail->bank_name ?? '-'); ?></td>
                                                <td><?php echo e($detail->branch_name ?? '-'); ?></td>
                                                <td><?php echo e($detail->check_no ?? '-'); ?></td>
                                            <?php endif; ?>
                                            <td><?php echo e($detail->monthly_fee ?? ''); ?></td>
                                            <td><?php echo e($detail->monthly_fine ?? ''); ?></td>
...
<?php /**PATH C:\xampp\htdocs\somiti\resources\views/monthlydeposit/money-receipt.blade.php ENDPATH**/ ?>