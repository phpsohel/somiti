        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center" id="">
                    <?php echo e(($depositdetail->member->name ?? '') . ' (' . ($depositdetail->member->member_code ?? '') . ')'); ?>
            ...
            <form action="<?php echo e(route('depositPayment')); ?>" class="" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="row">

                        <input type="hidden" name="deposit_details_id" value="<?php echo e($depositdetail->id); ?>">
                        <input type="hidden" name="deposit_id" value="<?php echo e($depositdetail->monthly_deposits_id); ?>">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="number" step="any" name="monthly_fee"
                                value="<?php echo e(old('monthly_fee', $depositdetail->monthly_fee)); ?>"
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="number" name="monthly_fine" class="form-control monthly_fine" value="">
                        </div>
...
<?php /**PATH C:\xampp\htdocs\somiti\resources\views/monthlydeposit/deposit_collection_modal.blade.php ENDPATH**/ ?>