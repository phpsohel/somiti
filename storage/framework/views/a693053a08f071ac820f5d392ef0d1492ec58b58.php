<?php $__env->startSection('content'); ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('updateweeklydepositPayment', $details->id)); ?>" class="" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            <label> weekly Fee <sup class="text-danger">*</sup></label>
                            <input type="number" step="any" name="weekly_fee" value="<?php echo e($details->weekly_fee); ?>"
                                class="form-control weekly_fee" required readonly>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="number" name="weekly_fine" class="form-control"
                                value="<?php echo e($details->weekly_fine); ?>">
                        </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\somiti\resources\views/weeklydeposit/money_receipt_edit.blade.php ENDPATH**/ ?>