...
<body>
    <div class="page login-page" style="background: url(<?php echo asset('public/images/somiti.jpg'); ?>); background-size: cover;">
        <div class="container">
            <div class="form-outer text-center d-flex align-items-center"
                style="max-width: 490px !important;min-height: 85vh !important;">
                    ...
                    <?php if(session()->has('delete_message')): ?>
                        <div class="alert alert-danger alert-dismissible text-center"><button type="button"
                                class="close" data-dismiss="alert" aria-label="Close"><span
                                    aria-hidden="true">&times;</span></button><?php echo e(session()->get('delete_message')); ?>
            ...
            <div class="row">
                <div class="col-4">
                    <h3 style="color:black;margin-top:20px;">Powered by:</h3>

                    <img src="<?php echo e(asset('public/images/logo.png')); ?>"
                        style="height:30px;width:110px;float:left;margin-bottom:20px;">
                </div>
...
<?php /**PATH C:\xampp\htdocs\somiti\resources\views/auth/login.blade.php ENDPATH**/ ?>