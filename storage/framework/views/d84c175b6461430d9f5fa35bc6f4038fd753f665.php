<div class="modal fade" id="loanDeposite_<?php echo e($depositdetail->id); ?>" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('dailydepositPayment')); ?>" class="" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="row">

                        <input type="hidden" name="deposit_details_id" value="<?php echo e($depositdetail->id); ?>">
                        <input type="hidden" name="deposit_id" value="<?php echo e($depositdetail->daily_deposit_id); ?>">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="number" step="any" name="daily_fee"
                                value="<?php echo e(old('daily_fee', $depositdetail->daily_fee)); ?>" class="form-control daily_fee"
                                required readonly>
...
<?php /**PATH C:\xampp\htdocs\somiti\resources\views/dailydeposit/deposit_collection_modal.blade.php ENDPATH**/ ?>