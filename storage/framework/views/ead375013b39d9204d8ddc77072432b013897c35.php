            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-center">
                        <h4>Generate Yearly Deposit for all General Member</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('yearlydeposite.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <?php
                                $years = [
...
<script type="text/javascript">
    ...
    $("ul#general #general-add-yearly-deposit-menu").addClass("active");
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\somiti\resources\views/yearlydeposit/create.blade.php ENDPATH**/ ?>