                        ...
                        <table class="table table-bordered table-sm table-striped text-nowrap">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th class="text-right"><?php echo e(trans('Daily fee')); ?></th>
                                    <th class="text-right"><?php echo e(trans('Daily fine')); ?></th>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $grand_total = 0;
                                ?>
                                <?php $__currentLoopData = $dailyDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><?php echo e($detail->daily_fee ?? 0); ?></td>
                                        <td class="text-right"><?php echo e($detail->daily_fine ?? 0); ?></td>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\somiti\resources\views/report/daily_contribution_report_search.blade.php ENDPATH**/ ?>