                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <?php echo Form::open(['route' => 'somiti-loan.store', 'method' => 'post', 'files' => true]); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 all_member_list">
                                    <div class="form-group">
                                        <label><?php echo e(trans('Member')); ?> </label>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" step="any" name="loan_code" value="<?php echo e($code ?? ''); ?>"
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="date" step="any" name="loan_release_date"
                                        value="<?php echo e(date('Y-m-d')); ?>" class="form-control" required>
                                </div>
                                
                                <div class="col-md-6 form-group">
                                    <label> Principal Amount <sup class="text-danger">*</sup></label>
                                    <input type="number" step="any" name="principal_amount"
                                        value="<?php echo e(old('principal_amount')); ?>" class="form-control principal_amount"
                                        required>
                                ...
                                <div class="col-md-6 form-group" id="loan_interest">
                                    ...
                                    <input type="text" step="any" name="loan_interest"
                                        value="<?php echo e(old('loan_interest')); ?>" class="form-control loan_interest" required>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" id="loan_interest_amount" name="loan_interest_amount"
                                        value="<?php echo e(old('loan_interest_amount')); ?>" readonly
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="number" name="loan_duration" value="<?php echo e(old('loan_duration')); ?>"
                                        class="form-control" required>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="number" name="grand_total" class="form-control grand_total"
                                        value="<?php echo e(old('grand_total')); ?>" required readonly>

                                </div>

                            </div>
                            <div class="form-group">
                                <a href="<?php echo e(route('somiti-loan.index')); ?>" class="btn btn-success btn-sm"> <i
                                        class="fa fa-undo px-2"></i> Back</a>

                                <button type="submit"
                                    class="btn btn-primary btn-sm pull-right"><?php echo e(trans('file.submit')); ?></button>
                            </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\somiti\resources\views/somiti-loan/create.blade.php ENDPATH**/ ?>